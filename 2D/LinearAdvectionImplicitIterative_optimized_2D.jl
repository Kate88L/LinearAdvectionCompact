...
for n = 1:Ntau + 3
    ...
    phi1[2, :, :] = phi_exact.(x[2], y, t[n]);
    phi2[2, :, :] = phi_exact.(x[2], y, t[n]);
    phi[2, :, :] = phi_exact.(x[2], y, t[n]);
    phi_first_order[2, :, :] = phi_exact.(x[2], Y, t[n]);
    phi1[:, 2, :] = phi_exact.(x, y[2], t[n]);
    phi2[:, 2, :] = phi_exact.(x, y[2], t[n]);
    phi[:, 2, :] = phi_exact.(x, y[2], t[n]);
    phi_first_order[:, 2, :] = phi_exact.(x, y[2], t[n]);
end
